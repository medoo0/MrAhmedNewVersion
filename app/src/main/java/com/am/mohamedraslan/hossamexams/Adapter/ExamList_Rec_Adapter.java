...
import com.am.mohamedraslan.hossamexams.JsonModel.AddExam_pojo;
...
import com.am.mohamedraslan.hossamexams.Views.Exam;
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.POST, "https://fcm.googleapis.com/fcm/send", obj,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        com.am.mohamedraslan.hossamexams.Dialog.AlertDialog alertDialog
                                = new com.am.mohamedraslan.hossamexams.Dialog.AlertDialog(context, "لقد تم الطلب يرجي الانتظار حتي يوافق Mr.Ahmed Samy علي طلبك.");
                        alertDialog.show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        dialog.Close_Dialog();
                        com.am.mohamedraslan.hossamexams.Dialog.AlertDialog alertDialog
                                = new com.am.mohamedraslan.hossamexams.Dialog.AlertDialog(context, "تاكد من الإتصال بالإنترنت.");
                        alertDialog.show();
               ...
               referencep.child(ExamID).child(uID).addListenerForSingleValueEvent(new ValueEventListener() {
                   ...
                   public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                       ...
                       if (dataSnapshot.exists()){
                           ...
                           com.am.mohamedraslan.hossamexams.Dialog.AlertDialog alertDialog
                                   = new com.am.mohamedraslan.hossamexams.Dialog.AlertDialog(context, "لقد إنتهي وقت إختبارك وقمت بالطلب من  Mr.Ahmed Samy من قبل.");
                           alertDialog.show();
